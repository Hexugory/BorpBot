...
module.exports = class BuyRollsCommand extends commando.Command {
	constructor(client) {
		super(client, {
			...
			group: 'gacha',
			memberName: 'buyrolls',
			description: 'Buy gacha rolls for 2000 BorpDust.\nExclusive to Touhou Discord.',
	...
	async run(msg, args) {
		...
		if(!duelstats[msg.author.id] || duelstats[msg.author.id].borpdust < 2000*args.amount) return msg.reply("You don't have enough BorpDust.");
		duelstats[msg.author.id].borpdust -= 2000*args.amount;
